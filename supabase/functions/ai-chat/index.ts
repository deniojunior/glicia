...
const turnSchema = {
  ...
  properties: {
    ...
    meal_items: { type: "array", items: { type: "object", additionalProperties: false, required: ["name", "portion", "carbohydrates"], properties: { name: { type: "string", minLength: 1 }, portion: { type: "string", minLength: 1 }, carbohydrates: { type: "number", minimum: 0 } } } },
