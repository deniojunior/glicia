...
import type { BackupService, GliciaBackup } from "../application";
...
interface SettingsProps {
  ...
  onRestored(backup: GliciaBackup): void;
  onBack(): void;
}
...
export function Settings({ preferences, hasApiKey, onSave, onSetApiKey, backupService, onRestored, onBack }: SettingsProps) {
