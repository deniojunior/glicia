...
[![Versão](https://img.shields.io/badge/version-0.11.0--alpha-8b5cf6?style=flat-square)](docs/releases/v0.11.0-alpha.md)
...
**Status:** `v0.11.0-alpha` · CLI Python utilizável · PWA experimental com acesso aprovado
...
- **Próximo marco:** modelos e múltiplos provedores de IA na `v0.12.0-alpha`.

Leia as [notas da v0.11.0-alpha](docs/releases/v0.11.0-alpha.md) para conhecer a nova experiência,
